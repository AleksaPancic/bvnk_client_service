...
VALUES
    (1, 'Country1', 'State1', '12345', 'City1', 'Street1', 'Test1'),
    (2, 'Country2', 'State2', '54321', 'City2', 'Street2', 'Test2'),
    (3, 'Country3', 'State3', '98765', 'City3', 'Street3', 'Test3');

-- Populate clients table
INSERT INTO clients (client_id, first_name, last_name, email, phone_number, role, date_of_birth, address_id, created_at, updated_at)
VALUES
    (1, 'John', 'Doe', 'john@example.com', '123456789', 'USER', '1990-01-01', 1, NOW(), NOW()),
